 ...
 *      - Use hklist_set_item() to set attributes, since it provides
 *          "memory-safe" assignment of the 'command'-attribute.
 ...
 *          'head'-item of the list to remove ALL items from memory. Otherwise,
 *          only items beginning at the right from the passed item will be
 *          removed.
 ******************************************************************************/
